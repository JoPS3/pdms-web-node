...
const { requireGatewayAuth } = require('./middlewares/session.middleware');
const internalRoutes = require('./routes');
const usersGuiController = require('./controllers/users.gui.controller');

const app = express();
const isDev = process.env.NODE_ENV === 'development';
const configuredBasePath = isDev ? process.env.BASE_PATH_DEV : process.env.BASE_PATH_PROD;
const preferredBasePath = isDev ? '/pdms-new/sysadmin' : '/pdms/sysadmin';

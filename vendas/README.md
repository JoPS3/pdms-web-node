...
Aplicacao Node.js + Express para o modulo `vendas`, integrada com autenticacao centralizada no `pdms-gateway`.

## Objetivo

- Disponibilizar o launcher/shell principal do modulo Vendas.
...
- `PORT=6003`
- `BASE_PATH_DEV=/pdms-new/vendas`
- `BASE_PATH_PROD=/pdms/vendas`
...
3. Navegacao para `/pdms-new/apps/vendas` (ou `/pdms/apps/vendas`).
